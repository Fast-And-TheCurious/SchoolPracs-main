    ...
    lessons: [
      {
        ...
        uniquelessonTitles: {
          lessonpageTitle: "Course Overview",
...
function populateSidebar(unitIndex) {
    ...
    sidebar.innerHTML = ''; // Clear the previous content

    // Display the unit and title at the top
    ...
    const uniqueLessonTitles = lessonDataExport.lessons[unitIndex].uniquelessonTitles;
